...
const employeeSchema = new mongoose.Schema(
  {
    ...
    no_of_family_members: { type: String, required: true, unique: true },
    ...
    aadhar_card_file: { type: String, required: true },
    pan_card_file: { type: String, required: true },
    bank_account_file: { type: String, required: true },
