...
// const YourReferalHistory = () => {
//   return <div className="container">YourReferalHistory</div>;
// };

// export default YourReferalHistory;
    ...
    const fetchData = async () => {
      ...
      try {
        const result = await axios.get(
          `/api/jobs/jobreferral/individual/${userInfo.employee_id}`,
          {
